          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image: { url: `https://telegra.ph/file/b2b2008007c558204e8b8.mp4` } }, { upload: Matrix.waUploadToServer })),
                title: ``,
                gifPlayback: true,
                subtitle: "",
