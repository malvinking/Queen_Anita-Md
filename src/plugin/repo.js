...
const handleRepoCommand = async (m, Matrix) => {
  const repoUrl = 'https://api.github.com/repos/DeeCeeXxx/Queen_Anita-Md';
  try {
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            header: proto.Message.InteractiveMessage.Header.create({
             ...(await prepareWAMessageMedia({ image: { url: `https://telegra.ph/file/fc93147ff90768ff55f96.jpg` } }, { upload: Matrix.waUploadToServer })),
              title: "",
              gifPlayback: true,
              subtitle: "",
              ...
              buttons: [
                ...
                },
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://github.com/DeeCeeXxx/Queen_Anita-Md/fork`
                  })
                },
                {
                  name: "cta_url",
